...
alertThreshold = 5 # ENTER YOUR DESIRED ALERT LISTENER THRESHOLD HERE
alertSubject = "[YOUR CHANNEL NAME HERE] Broadcastify Alert" # ENTER YOUR BROADCASTIFY CHANNEL NAME HERE
